...
export const store = new Vuex.Store({
    ...
    mutations: {
            ...
            const updatedItems = state.itemList.map((it, idx) => {
                if(idx === index){
                    ...
                    if(!state.selectedItems.fromItem){
                        ...
                        console.log("state.selectedItems.fromItem:: ", state.selectedItems.fromItem);
                    }
        ...
        SELECT_TO_ITEM: (state, index) => {
            ...
            console.log("state.selectedItems fromItem.amount:: ",  state.selectedItems.fromItem.amount);
           
                const diffAmount = state.selectedItems.fromItem.amount - toItem.amount;
                const diffAmountPercent = (diffAmount / state.selectedItems.fromItem.amount) * 100
        ...
        TOGGLE_PERCET_AMOUNT: (state) => {
            ...
            state.header.showPercent = locShowPercent;
        // state = {...state, header: {...state.header, showPercent: locShowPercent}}
        }
